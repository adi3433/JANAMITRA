...
describe('BM25 Retriever', () => {
  it('retrieves relevant passages for registration query', { timeout: 20000 }, async () => {
  ...
  it('retrieves booth info for booth query', { timeout: 20000 }, async () => {
  ...
  it('retrieves document info', { timeout: 20000 }, async () => {
  ...
  it('ranks relevant passages higher', { timeout: 20000 }, async () => {
  ...
  it('respects token budget', { timeout: 20000 }, async () => {
